  ...
  return (
    <div className="home__data">
      ...
      <h3 className="home__subtitle">
        Full Stack | MERN | WordPress | Outsystems Developer | IT Instructor
      </h3>
      <p className="home__description">
        Hello there! I'm a passionate full-stack web developer with a rich
        background in the IT industry. I've honed my skills through various
        certifications, hands-on training, and valuable experiences. Beyond
        coding, I'm also an enthusiastic IT teacher, having spent 8 years
        shaping the minds of college and senior high school students.
      </p>
      <p className="home__description">
        What sets me apart is my flexibility and ability to thrive in different
        work environments. Whether I'm flying solo or collaborating as part of a
        team, I'm committed to delivering top-notch results. I'm a goal-driven
        individual who takes pride in making technology accessible and exciting
        for others. Let's create something amazing together!
      </p>

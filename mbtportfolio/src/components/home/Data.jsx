...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">A skilled web developer with competitive certifications, trainings
and experiences in IT industry works. A goal-oriented IT
teacher/instructor with 8 years experience in teaching college and
senior high school students. A flexible worker who works well in
any work set whether working independently or as a team player.</p>
        <a href="#ontact" className="button button--flex"> Say Hello
            <svg
                class="button__icon"
                xmlns="http://www.w3.org/2000/svg"
                width="24"

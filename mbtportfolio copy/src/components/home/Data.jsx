...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <h3 className="home__subtitle">Web Developer | IT Instructor</h3>
        <p className="home__description">A skilled web developer and IT teacher/instructor with competitive certifications, trainings
and experiences in IT industry works and teaching. </p>
